<template>
  <div>
    ...
    <el-row>
      ...
      <el-col :span="12">
        <el-card style="margin-top:1px;" v-for="item in final_summary">
          <template #header>
          ...
          <el-button @click="btnSummary(item)" type="primary">总结</el-button>
          <hr/>
          <el-tag style="font-size: 14px;">总结:</el-tag><span style="font-size: 12px; " >{{item.summary}}</span>
        </el-card>
